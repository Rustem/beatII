...
In Section~\ref{sect:impl}, we explain a refinements a protocols used by a Cloud provider, implemented using SJ. %and how they can be implemented correctly using session programming.
