...
The need for highly available services present challenges for application development.
...
Next, in Section~\ref{sect:impl}, we provide detailed explanation of business protocols used by an e-commerce Cloud provider~\cite{v3na-cloud}. %Make this citation a footnote.
